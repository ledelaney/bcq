...
<table class="table" style="max-width:900px;margin-left:auto;margin-right:auto">
  ...
  <tr>
  <td>[<i class="far fa-envelope"></i> Submit to Zahraa Abbas](mailto:boxemail@box.com) \ \ `boxemail@box.com`</td>
  <td>[<i class="far fa-envelope"></i> Submit to Hadeel Abdallah](mailto:boxemail@box.com)\ \ `boxemail@box.com`</td>
  </tr>
  
  <tr>
  <td>[<i class="far fa-envelope"></i> Submit to Leo Calderon](mailto:boxemail@box.com) \ \ `boxemail@box.com`</td>
  <td>[<i class="far fa-envelope"></i> Submit to Sania Ali](mailto:boxemail@box.com)\ \ `boxemail@box.com`</td>
  </tr>
  
  <tr>
  <td>[<i class="far fa-envelope"></i> Submit to Mohammed Basem Jalal](mailto:boxemail@box.com) \ \ `boxemail@box.com`</td>
  <td>[<i class="far fa-envelope"></i> Submit to Janet Corona](mailto:boxemail@box.com)\ \ `boxemail@box.com`</td>
  </tr>
  
  <tr>
  <td>[<i class="far fa-envelope"></i> Submit to Natalie Para](mailto:boxemail@box.com) \ \ `boxemail@box.com`</td>
  <td>[<i class="far fa-envelope"></i> Submit to Alyssa Redini Ramos](mailto:boxemail@box.com)\ \ `boxemail@box.com`</td>
  </tr>
  
  <tr>
  <td>[<i class="far fa-envelope"></i> Submit to Yarah Qaud](mailto:boxemail@box.com) \ \ `boxemail@box.com`</td>
  <td>[<i class="far fa-envelope"></i> Submit to Godwin Sarpey](mailto:boxemail@box.com)\ \ `boxemail@box.com`</td>
  </tr>
