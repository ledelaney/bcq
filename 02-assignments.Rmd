...
<table class="table" style="max-width:900px;margin-left:auto;margin-right:auto">
  ...
  <tr>
  <td>[<i class="far fa-envelope"></i> Submit to Zahraa](mailto:boxemail@box.com) \ \ `boxemail@box.com`</td>
  <td>[<i class="far fa-envelope"></i> Submit to Hadeel](mailto:boxemail@box.com)\ \ `boxemail@box.com`</td>
  </tr>
  
  <tr>
  <td>[<i class="far fa-envelope"></i> Submit to Leo](mailto:boxemail@box.com) \ \ `boxemail@box.com`</td>
  <td>[<i class="far fa-envelope"></i> Submit to Sania](mailto:boxemail@box.com)\ \ `boxemail@box.com`</td>
  </tr>
  
  <tr>
  <td>[<i class="far fa-envelope"></i> Submit to Mohammed](mailto:boxemail@box.com) \ \ `boxemail@box.com`</td>
  <td>[<i class="far fa-envelope"></i> Submit to Janet](mailto:boxemail@box.com)\ \ `boxemail@box.com`</td>
  </tr>
  
  <tr>
  <td>[<i class="far fa-envelope"></i> Submit to Natalie](mailto:boxemail@box.com) \ \ `boxemail@box.com`</td>
  <td>[<i class="far fa-envelope"></i> Submit to Alyssa](mailto:boxemail@box.com)\ \ `boxemail@box.com`</td>
  </tr>
  
  <tr>
  <td>[<i class="far fa-envelope"></i> Submit to Yarah](mailto:boxemail@box.com) \ \ `boxemail@box.com`</td>
  <td>[<i class="far fa-envelope"></i> Submit to Godwin](mailto:boxemail@box.com)\ \ `boxemail@box.com`</td>
  </tr>
